...
async function enviarDadosParaBackend(dados) {
    ...
    try {
        ...
        if (response.ok) {
            ...
            console.log('Estabelecimento criado:', resultado);
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    campos.forEach(campo => {
        ...
        campo.addEventListener('input', function() {
            // Remove erro visual enquanto digita
    ...
    form.addEventListener('submit', function(e) {
        ...
        if (validarFormulario(formData, form)) {
            ...
            const primeiroErro = form.querySelector('.field--error input, .field--error select');
            if (primeiroErro) {
                primeiroErro.focus();
            }
        }
